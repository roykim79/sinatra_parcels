...
describe Parcel do
  ...
  describe '#volume_cost' do
    it 'returns the cost at a rate of $1.50/cubic-inch' do
      ...
      expect(parcel.volume_cost()).to eq('1.50')
    end

    it 'returns the cost at a rate of $1.50/cubic-inch' do
      parcel = Parcel.new(1, 2, 1, 1)
      expect(parcel.volume_cost()).to eq('3.00')
    end

    it 'returns the cost at a rate of $1.50/cubic-inch' do
      parcel = Parcel.new(1, 2, 2, 1)
      expect(parcel.volume_cost()).to eq('6.00')
    end
  end
  ...
  describe '#weight_cost' do
    it 'returns the cost at a rate of $1.25/ounce' do
      ...
      expect(parcel.weight_cost()).to eq('2.50')
    end
    ...
    it 'returns the cost at a rate of $1.25/ounce' do
      ...
      expect(parcel.weight_cost()).to eq('12.50')
    end
  end
  ...
  describe '#cost_to_ship' do
    it 'returns the greater cost between volume_cost and weight_cost' do
      parcel = Parcel.new(1, 1, 1, 1)
      expect(parcel.cost_to_ship()).to eq('1.50')
    end
    ...
    it 'returns the greater cost between volume_cost and weight_cost' do
      ...
      expect(parcel.cost_to_ship()).to eq('6.00')
    end
  end
end
